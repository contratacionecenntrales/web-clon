          ...
          <div className="phases">
            <div className="phase-row reveal">
              <div className="phase-row__rail">
                <div className="phase-row__node" aria-hidden="true" style={{'--node-color': '#0563a7'} as CSSProperties}>
            ...
            <div className="phase-row reveal" data-reveal-delay="100">
              <div className="phase-row__rail">
                <div className="phase-row__node" aria-hidden="true" style={{'--node-color': '#ed2566'} as CSSProperties}>
            ...
            <div className="phase-row reveal" data-reveal-delay="200">
              <div className="phase-row__rail">
                <div className="phase-row__node" aria-hidden="true" style={{'--node-color': '#02b5b2'} as CSSProperties}>
