        ...
        <div className="container">
          ...
          <div className="timeline">
            <div className="timeline__moment reveal">
              <div className="timeline__dot" style={{'--dot-color': '#0563a7'} as CSSProperties}></div>
              ...
              <div className="service-cards">
                <article className="service-card">
                  <div className="service-card__head">
                    <div className="service-card__icon" aria-hidden="true" style={{'--icon-color': '#0563a7'} as CSSProperties}>
                  ...
                  <span className="service-card__arrow" aria-hidden="true" style={{'--icon-color': '#0563a7'} as CSSProperties}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7 17 17 7"/><path d="M7 7h10v10"/></svg></span>
                </article>
                <article className="service-card">
                  <div className="service-card__head">
                    <div className="service-card__icon" aria-hidden="true" style={{'--icon-color': '#0563a7'} as CSSProperties}>
                ...
                <article className="service-card">
                  <div className="service-card__head">
                    <div className="service-card__icon" aria-hidden="true" style={{'--icon-color': '#02b5b2'} as CSSProperties}>
                  ...
                  <span className="service-card__arrow" aria-hidden="true" style={{'--icon-color': '#02b5b2'} as CSSProperties}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7 17 17 7"/><path d="M7 7h10v10"/></svg></span>
                </article>
              </div>
            </div>

            <div className="timeline__moment reveal" data-reveal-delay="120">
              <div className="timeline__dot" style={{'--dot-color': '#02b5b2'} as CSSProperties}></div>
            ...
            <div className="timeline__moment reveal" data-reveal-delay="240">
              <div className="timeline__dot" style={{'--dot-color': '#ed2566'} as CSSProperties}></div>
              ...
              <div className="service-cards">
                <article className="service-card">
                  <div className="service-card__head">
                    <div className="service-card__icon" aria-hidden="true" style={{'--icon-color': '#ed2566'} as CSSProperties}>
                  ...
                  <span className="service-card__arrow" aria-hidden="true" style={{'--icon-color': '#ed2566'} as CSSProperties}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7 17 17 7"/><path d="M7 7h10v10"/></svg></span>
                </article>
                <article className="service-card">
                  <div className="service-card__head">
                    <div className="service-card__icon" aria-hidden="true" style={{'--icon-color': '#ed2566'} as CSSProperties}>
