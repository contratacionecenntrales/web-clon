...
const de: Dictionary = {
  ...
  book: {
    ...
    coverEyebrow: "Angewandte Künstliche Intelligenz",
    coverTitle: "Der Exzellenz-Leitfaden für skalierende Unternehmen",
    coverSubtitle: "Strategie, Erfolgsgeschichten & Umsetzung",
    coverAuthor: "Labs24k Team",
    heading: "Entdecken Sie die Zukunft Ihres Unternehmens",
    bodyPre: "95% der Führungskräfte wissen noch nicht, wie sie KI wirksam einsetzen können. ",
    bodyStrong: "Dieses Buch verschafft Ihnen den Wettbewerbsvorteil",
    bodyPost: ", den Sie brauchen, um nicht ins Hintertreffen zu geraten.",
    checklist: [
      "14 Kapitel mit praktischer Strategie und echten Fallbeispielen",
      "Entscheidungsrahmen, untermauert von Deloitte, PwC, McKinsey und MIT",
      "Exklusive, sofort einsetzbare Vorlagen und Checklisten",
      "Living Edition: laufend aktualisiert mit dem Redaktionsbeirat",
    ],
    ctaPrimary: "Jetzt kostenlos herunterladen",
    ctaNote: "Sofortiger Zugriff als PDF",
  },
  services: {
    label: "Leistungen",
