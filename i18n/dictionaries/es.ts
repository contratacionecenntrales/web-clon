...
const es = {
  ...
  book: {
    ...
    coverEyebrow: "Inteligencia Artificial Aplicada",
    coverTitle: "Guía de Excelencia para Escalar Empresas",
    coverSubtitle: "Estrategia, Casos de Éxito e Implementación",
    coverAuthor: "Equipo Labs24k",
    heading: "Descubre el futuro de tu empresa",
    bodyPre: "El 95% de los líderes todavía no sabe cómo integrar la IA de forma efectiva. ",
    bodyStrong: "Este libro te da la ventaja competitiva",
    bodyPost: " que necesitas para no quedarte atrás.",
    checklist: [
      "14 capítulos con estrategia práctica y casos reales",
      "Marcos de decisión respaldados por Deloitte, PwC, McKinsey y MIT",
      "Plantillas y checklists exclusivos listos para usar",
      "Edición Viva: contenido actualizado con el Consejo Editorial",
    ],
    ctaPrimary: "Descargar ahora gratis",
    ctaNote: "Acceso inmediato en PDF",
  },
  services: {
    label: "Servicios",
