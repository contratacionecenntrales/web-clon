...
const en: Dictionary = {
  ...
  book: {
    ...
    coverEyebrow: "Applied Artificial Intelligence",
    coverTitle: "The Excellence Guide to Scaling Companies",
    coverSubtitle: "Strategy, Success Stories & Implementation",
    coverAuthor: "Labs24k Team",
    heading: "Discover the future of your company",
    bodyPre: "95% of leaders still don't know how to integrate AI effectively. ",
    bodyStrong: "This book gives you the competitive edge",
    bodyPost: " you need so you don't get left behind.",
    checklist: [
      "14 chapters of practical strategy and real cases",
      "Decision frameworks backed by Deloitte, PwC, McKinsey and MIT",
      "Exclusive templates and checklists ready to use",
      "Living Edition: content updated with the Editorial Board",
    ],
    ctaPrimary: "Download now for free",
    ctaNote: "Instant access as a PDF",
  },
  services: {
    label: "Services",
