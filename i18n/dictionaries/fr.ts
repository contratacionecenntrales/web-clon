...
const fr: Dictionary = {
  ...
  book: {
    ...
    coverTitlePre: "LA MÉTHODE",
    coverTitleHighlight: "IA",
    coverEdition: "Édition Vivante",
    coverSubtitle: "Comment créer et développer des entreprises grâce à l'intelligence artificielle",
    coverAuthor: "Équipe Labs24k",
    heading: "La Méthode IA : le système pour que l'IA donne des résultats",
    bodyPre: "95% des pilotes IA ne génèrent aucun retour. ",
    bodyStrong: "La Méthode IA",
    bodyPost:
      " est le livre, open source et vivant, qui fait passer l'intelligence artificielle du pilote au compte de résultat. Pensé pour les décideurs. Gratuit.",
    checklist: [
      "14 chapitres avec des cadres de décision pour la direction et le comité",
      "Étayé par les données de Deloitte, PwC, McKinsey et le MIT",
      "Édition Vivante : open source et mise à jour avec le Conseil Éditorial",
    ],
    ctaPrimary: "Télécharger le livre gratuitement",
    ctaSecondary: "Voir ce qu'il contient",
  },
  services: {
    label: "Services",
