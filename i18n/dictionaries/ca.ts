...
const ca: Dictionary = {
  ...
  book: {
    ...
    coverEyebrow: "Intel·ligència Artificial Aplicada",
    coverTitle: "La Guia d'Excel·lència per Escalar Empreses",
    coverSubtitle: "Estratègia, Casos d'Èxit i Implementació",
    coverAuthor: "Equip Labs24k",
    heading: "Descobreix el futur de la teva empresa",
    bodyPre: "El 95% dels líders encara no sap com integrar la IA de forma efectiva. ",
    bodyStrong: "Aquest llibre et dona l'avantatge competitiu",
    bodyPost: " que necessites per no quedar-te enrere.",
    checklist: [
      "14 capítols amb estratègia pràctica i casos reals",
      "Marcs de decisió recolzats per Deloitte, PwC, McKinsey i el MIT",
      "Plantilles i checklists exclusius llestos per usar",
      "Edició Viva: contingut actualitzat amb el Consell Editorial",
    ],
    ctaPrimary: "Descarregar ara gratis",
    ctaNote: "Accés immediat en PDF",
  },
  services: {
    label: "Serveis",
